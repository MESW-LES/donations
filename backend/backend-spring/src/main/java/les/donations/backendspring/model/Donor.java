...
public class Donor {
    ...
    public Donor(Long id, String firstName, String lastName, String nif, String address, String email, String password) throws IllegalArgumentException {
        this.id = id;
    ...
    public void setNif(String nif) throws IllegalArgumentException {
        ...
        if (!isMatch) {
            throw new IllegalArgumentException("The nif has illegal format");
        }
        this.nif = nif;
    }
