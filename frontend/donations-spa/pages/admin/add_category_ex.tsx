...
const [name, setName] = useState("reter");
const [description, setDescription] = useState("ertert");
                  ...
                  <div className="bg-white px-4 py-5 sm:p-6">
                    <div className="grid grid-cols-6 gap-6">
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        minLength={1}
                        maxLength={50}
                        onSubmit = {({target})=> setName(target?.name.valueOf)}
                          type="text"
                          name="category-name"
                          id="category-name"
                      ...
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        minLength={1}
                        maxLength={280}
                        onSubmit = {({target})=> setDescription(target?.name.valueOf)}
                          type="text"
