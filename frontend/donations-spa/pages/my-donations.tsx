        ...
        <div className="col-12">
            <div className="flex flex-column md:flex-row align-items-center p-3 w-full">                
                ...
                <div className="flex flex-row md:flex-column justify-content-between w-full md:w-auto align-items-center md:align-items-end mt-5 md:mt-0">
                    ...
                    <Button onClick={()=>{deleteDonation(data.id)}} icon="pi pi-trash" label="Delete donation" disabled={data.donationProcess.status.toUpperCase() === 'END' || data.donationProcess.status.toUpperCase() === 'ONGOING' || data.donationProcess.status.toUpperCase() === 'REQUESTED'} className="mb-2 bg-red-300 border-red-400 p-button-sm"></Button>
        ...
        <div className="col-12 lg:col-4">
            <div className="card m-3 border-1 surface-border">
                ...
                <div className="flex align-items-center justify-content-between">
                    ...
                    <div>
                    <Button onClick={()=>{deleteDonation(data.id)}} icon="pi pi-trash"  disabled={data.donationProcess.status.toUpperCase() === 'END' || data.donationProcess.status.toUpperCase() === 'ONGOING' || data.donationProcess.status.toUpperCase() === 'REQUESTED'} className=" bg-red-300 border-red-400 "></Button>
